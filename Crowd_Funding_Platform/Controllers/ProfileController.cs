...
namespace Crowd_Funding_Platform.Controllers
{
    public class ProfileController : BaseController
    {
        ...
        public ProfileController(IProfileRepos profileRepos,DbMain_CFS dbMain_CFS, IEmailSenderRepos emailSender,IAccountRepos accountRepos, ISidebarRepos sidebar ) : base(sidebar)
        {
        ...
        //        var updatedUser= await _profileRepos.EditProfile(user, ImageFile);
